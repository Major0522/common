...
public class LogOutputStream extends OutputStream {
	/**
	 * 将System.out和System.err的输出转移到log4j
	 */
	public static void systemOut2Log4j() {
		Logger log = Logger.getRootLogger();
		log.info("systemOut2Log4j!!!");
		if (log.getAllAppenders().hasMoreElements()) {
			System.setErr(new PrintStream(
					new LogOutputStream(log, Level.ERROR), true));
			System.setOut(new PrintStream(new LogOutputStream(log, Level.WARN),
					true));
		}
	}
	 ...
	 */
	public LogOutputStream(final Logger log, final Level level)
			throws IllegalArgumentException {
