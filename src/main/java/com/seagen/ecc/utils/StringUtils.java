...
public class StringUtils {
     ...
     * @param version2
     *            版本2,如"2.9.0"
     * @return 格式不正确则返回null;version1大于version2则返回大于0;version1小于version2则返回小于0;version1等于version2则返回等于0;
     */
    public static Integer versionCompare(String version1, String version2) {
        if (StringUtils.matches("(\\d+.)+\\d+", version1, version2)) {
            ...
            for (int i = 0; i < a.length && i < b.length; i++) {
                if (!a[i].equals(b[i])) {
                    return Integer.valueOf(a[i]).compareTo(Integer.valueOf(b[i]));
                }
            }
	...
	public static void main(String[] args) {
	    System.out.println("2.9.0".compareTo("2.10.0"));
	    System.out.println(versionCompare("1.2.9","2.10.0"));
	}
